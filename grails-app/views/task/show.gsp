	...
	<body>
		...
		<div id="show-task" class="content scaffold-show" role="main">
			...
			<ol class="property-list task">
				...
				<g:if test="${taskInstance?.projects}">
				<li class="fieldcontain">
					<span id="projects-label" class="property-label"><g:message code="task.projects.label" default="Projects" /></span>
					
						<span class="property-value" aria-labelledby="projects-label"><g:link controller="project" action="show" id="${taskInstance?.projects?.id}">${taskInstance?.projects?.encodeAsHTML()}</g:link></span>
